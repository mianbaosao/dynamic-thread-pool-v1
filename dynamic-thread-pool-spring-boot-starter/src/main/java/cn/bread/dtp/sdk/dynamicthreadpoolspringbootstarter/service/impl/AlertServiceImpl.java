...
import cn.bread.dtp.sdk.dynamicthreadpoolspringbootstarter.strategy.Alert.AlertType;
import cn.bread.dtp.sdk.dynamicthreadpoolspringbootstarter.strategy.Alert.AlertTypeFactory;
    ...
    public void sendIfThreadPoolHasDanger(List<ThreadPoolConfigEntity> pools) {
        ...
        for (ThreadPoolConfigEntity pool : pools) {
            try {
                ...
                // 生成并发送告警信息
                AlertMessageDTO AlertMessageDTO = cn.bread.dtp.sdk.dynamicthreadpoolspringbootstarter.model.dto.AlertMessageDTO
